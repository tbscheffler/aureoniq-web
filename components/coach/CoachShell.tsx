...
export default function CoachShell({
  ...
  return (
    ...
    <div className="mx-auto grid max-w-[1700px] gap-8 px-5 py-6 lg:grid-cols-[260px_1fr] lg:py-8">
    <aside className="rounded-3xl border border-slate-800 bg-[#111827] p-4 sm:p-6 lg:sticky lg:top-6 lg:self-start">
        ...
        <CoachNavLink href="/coach/clients" label="Clients" currentPath={pathname} />
