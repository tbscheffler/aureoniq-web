create or replace function public.get_coach_client_summary(
    ...
    'career_reports', coalesce((
      select jsonb_agg(
        jsonb_build_object(
          ...
          'title', coalesce(cr.report_json->>'title', 'Career Discovery Report'),
          'summary', cr.report_json->>'summary'
        )
    ...
    'aiq_reports', coalesce((
      select jsonb_agg(
        jsonb_build_object(
          ...
          'title', coalesce(ar.report_json->>'title', 'AIQ Report'),
          'summary', ar.report_json->>'summary'
        )
